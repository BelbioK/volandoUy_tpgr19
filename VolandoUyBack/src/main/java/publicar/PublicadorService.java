 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://publicar/", wsdlLocation = "http://pcunix48.fing.edu.uy:8080/Publicador?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PUBLICADORSERVICE_QNAME = new QName("http://publicar/", "PublicadorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://pcunix48.fing.edu.uy:8080/Publicador?wsdl");
    ...
    public Publicador getPublicadorPort() {
        return super.getPort(new QName("http://publicar/", "PublicadorPort"), Publicador.class);
    }
    ...
    public Publicador getPublicadorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://publicar/", "PublicadorPort"), Publicador.class, features);
    }
