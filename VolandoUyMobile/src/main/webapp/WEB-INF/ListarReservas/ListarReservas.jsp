...
<head>
	...
	<link rel="stylesheet" href="styles/listar-reserva.css">
    ...
    <div id="root-listar-vuelos">
    	...
    	%>
    		<a class="ancla-contenedor" href="?vuelo=<%= reserva.getVuelo().getNombre() %>&cliente=<%= reserva.getCliente().getNickname() %>">
	            <div class="card" style="overflow-x:hidden;" id='card-<%= reserva.getVuelo().getNombre() + reserva.getCliente().getNickname() %>'>
	                ...
	                <div class="card-subtitle" style="display:flex;flex-wrap:wrap;justify-content:center; gap:10px">
    	...
    	%>
    			<div> <h1> No tiene ninguna reserva. </h1> </div>
    	<% } %>
	</div>
</body>
</html>